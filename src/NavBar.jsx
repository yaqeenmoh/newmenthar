...
//         <MDBNav>
//           <MDBNavItem>
//                     <a href="#!"><img classNameName="margin" src={questionmark}></img></a> 
//           </MDBNavItem>
//           <MDBNavItem>
//           <a href="#!"> <img classNameName="margin"  src={notification1}></img></a>
//           </MDBNavItem>
//           <MDBNavItem>
//           <a href="#!"><img
//           src={chat1}
//           alt="" classNameName="margin" >
//         </img></a>
...
//         <MDBDropdown>
//           <MDBDropdownToggle nav caret classNameName="white-text">
//             <span classNameName="white-text mr-2"> لين قطاونة</span>
//           </MDBDropdownToggle>
//           <MDBDropdownMenu>
...
//         </MDBDropdown>
//         <MDBCol md="6">
//           <input placeholder="ابحث عن معلمين, دورات ,أوراق عمل" type="text"  classNameName="form-control custom-control-text2 header-input"  style={{color:"white"  , opacity:1 }} />
//         </MDBCol>
//         <MDBNavbarNav right>
//         <MDBNavbarBrand>
//             <MDBContainer>
...
//                 <MDBCol classNameName="m-0 pl-2"><strong classNameName="white-text">JO | Academy</strong>
